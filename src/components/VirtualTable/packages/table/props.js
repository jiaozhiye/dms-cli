 ...
 * @Last Modified time: 2020-03-22 15:31:01
 */
...
const columnItem = {
  ...
  // 返回值: { type: string, items: array, editable: bool, rules: array }
  editRender: PropTypes.func, // 可编辑单元格，参数: row, column, rowIndex, cellIndex; 返回值类型: object
